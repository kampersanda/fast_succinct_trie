...
class SuRFBuilder {
  ...
  private:
    ...
    level_t insertKeyBytesToTrieUntilUnique(const std::string& key, const std::string& next_key,
...
void SuRFBuilder::setLabelAndChildIndicatorBitmap(const level_t level, const position_t node_num,
